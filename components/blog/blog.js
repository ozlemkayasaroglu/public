      ...
      <div className="flex justify-center items-center bg-gradient-to-b from-teal-100 to-white ">
        <div className="text-center mt-12">
          ...
          <p className="max-w-xs text-sm">
            Check out latest post to learn more about the different treatments
            and procedures.
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-center items-center mt-12">
        <div className="w-full max-w-4xl px-4 ">
          <div className="grid gap-8 ">
            <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-3 sm:gap-x-12  ">
              <div className="text-left sm:text-center">
                <Image
                  ...
                  height={400}
                />
                <p className="font-bold text-xs text-black whitespace-nowrap mt-4">
                  19.01.2023
                </p>
                <h2 className="font-bold text-sm text-black whitespace-nowrap mt-2">
                ...
                <p className="text-xs font-bold uppercase text-black mt-4">
                  read more...
                </p>
                <p className="text-xs text-black mt-2">
                  07 Jan 2022 +5 mins read
                </p>
              </div>
